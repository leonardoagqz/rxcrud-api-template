        ...
        public static void AddSwaggerSetup(this IServiceCollection services, string name, string version)
        {
            services.AddSwaggerGen(s =>
            {
                s.SwaggerDoc("v" + version, new OpenApiInfo
                {
                    Title = name,
                    Version = "v" + version,
                    Description = "Documentação da api do projeto rxcrud.<br/>" +
                        ...
                        "Em seguida o token deve ser enviado no Header da requisição: Authorization – Bearer Token.<br/><br/>" +
